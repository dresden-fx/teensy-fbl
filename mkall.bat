...
make -j -C .\driver\startup\imxrt\flash-boot PLATFORM=IMXRT version bin 2>&1 | tee -a report.txt
echo;                                                              2>&1 | tee -a report.txt
echo;                                                              2>&1 | tee -a report.txt

echo #### Building startup\flash-app #####                         2>&1 | tee -a report.txt
echo;                                                              2>&1 | tee -a report.txt
rem make -j -C .\driver\startup\imxrt\flash-app PLATFORM=IMXRT clean   2>&1 | tee -a report.txt
rem make -j -C .\driver\startup\imxrt\flash-app PLATFORM=IMXRT version bin     2>&1 | tee -a report.txt
echo;                                                              2>&1 | tee -a report.txt
echo;                                                              2>&1 | tee -a report.txt
